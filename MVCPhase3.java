 ...
 * 
 ***********************************************************************/
public class MVCPhase3 implements ActionListener
{
   public static void main(String[] args)
   {
      ...
      GameView gameView = new GameView("CardTable", NUM_CARDS_PER_HAND, NUM_PLAYERS);
   ...
   private static void createLabels()
   {
      ...
      for (int card = 0; card < NUM_CARDS_PER_HAND; card++)
      {
         ...
         cardButtons[card].addActionListener(new MVCPhase3());
...
class GameView 
{
   ...
   public GameView(String title, int numCardsPerHand, int numPlayers)
   {
      // establish main frame in which program will run
      myCardTable 
      = new CardTable(title, numCardsPerHand, numPlayers);
      myCardTable.setSize(800, 600);
      myCardTable.setLocationRelativeTo(null);
      myCardTable.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
      // Set up the play area layout
    ...
    * Helper method to create all the card labels on the game table
    */
    private void createLabels(int numCardsPerHand)
    {
       // Create the labels
...
class GameModel
{
   ...
   public void setCardGame(int numPacks, int numJokersPerPack, int numUnusedCardsPerPack, Card[] unusedCardsPerPack,
   int numPlayers, int numCardsPerHand)
   {
      LowCardGame = new CardGameFramework(
         numPacks, numJokersPerPack,
...
/*---------------------------------------------------------------
 * All following classes are Model classes for the low-card game
 ---------------------------------------------------------------*/
